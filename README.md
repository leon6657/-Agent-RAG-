...
- [4. 系统整体架构](#4-系统整体架构)
- [5. 四阶段演进路线](#5-四阶段演进路线)
  - [5.1 Phase 1：最小可用 RAG 原型](#51-phase-1最小可用-rag-原型)
  - [5.2 Phase 2：检索优化与评测体系](#52-phase-2检索优化与评测体系)
  - [5.3 Phase 3：Agent 智能体与联网搜索](#53-phase-3agent-智能体与联网搜索)
  - [5.4 Phase 4：工程化闭环与服务化](#54-phase-4工程化闭环与服务化)
- [6. RAG 知识库设计详解](#6-rag-知识库设计详解)
- [7. 检索优化设计详解](#7-检索优化设计详解)
- [8. Agent 决策系统设计](#8-agent-决策系统设计)
- [9. 联网搜索与自由对话兜底](#9-联网搜索与自由对话兜底)
- [10. 缓存、日志与工程化能力](#10-缓存日志与工程化能力)
- [11. 评测体系与实验结果](#11-评测体系与实验结果)
- [12. 核心技术难点与解决方案](#12-核心技术难点与解决方案)
- [13. 项目结构说明](#13-项目结构说明)
- [14. 快速开始](#14-快速开始)
- [15. 使用方式](#15-使用方式)
- [16. 项目亮点总结](#16-项目亮点总结)
- [17. 后续可扩展方向](#17-后续可扩展方向)
...
切分后当前索引片段总数约为 **344 个**，每个片段作为知识库中的最小检索单元。
...
如果只依赖语义检索，未必能把包含“Baseline Recall@4 = 1.000，Optimized Recall@4 = 1.000”的片段稳定排到最前。
...
当前 Optimized Recall@4 达到 1.000，体现出对 RAG 核心瓶颈——检索——的深入理解与优化能力。
