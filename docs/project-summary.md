...
**你的问题：** "今天是几月几日" — RAG 回答不了，因为笔记里没有日期信息。
...
**你的问题：** "赵日天是谁" — Agent 错误判断不需要搜索，直接用网络梗回答，没有用到笔记中的内容。
...
**你的问题：** Agent 回答的日期是错的（回答 2025 年，实际是 2026 年）。
...
**你的问题：** "陕西师范大学的人工智能与计算机学院的院长是谁" — DeepSeek 联网搜索返回"李葆华"，但正确答案是"姚若侠教授"。
...
**你的问题：** 问完问题后说"去查"，Agent 无法理解这是让它搜索之前的问题。
